	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				keymap.set("n", "<leader>lI", "<cmd>Telescope diagnostics bufnr=0<CR>", opts) -- show  diagnostics for file

				opts.desc = "Show line diagnostics"
				keymap.set("n", "<leader>li", vim.diagnostic.open_float, opts) -- show diagnostics for line
